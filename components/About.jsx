...
import AboutImg from '../public/assets/and.png';
      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
            ...
            clean code and work under high-paced and deadline-driven conditions .
             ready anytime to build high quality applications and deliver an 
